...
> Status: **pre-alpha, nothing runs yet.** Requirements, architecture and 22 issues are done; code starts January 2027. v0.1 target: March 2027. If you're here to help, see [Contributing](#contributing).
